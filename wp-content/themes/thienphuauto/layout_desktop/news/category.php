...
<!DOCTYPE html>
<html lang="vi-vn">
<?php get_template_part('layout_desktop/news/header-category'); ?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="blog-top-left d-flex">
                        <?php if($sticky_list->have_posts()): ?>
                            ...
                            <?php while ( $sticky_list->have_posts() ) : $sticky_list->the_post(); ?>
                                ...
                                <?php if($count_sticky_area_1 == '1'): ?>
                                    ...
                                    ?>
                        <div class="col-md-7 blog-larg" style="margin-right:15px;">
                            <div class="blog-item">
                        ...
                        <div class="col-md-5 blog-small">
                            <ul>
                        <?php if($sticky_list->have_posts()): ?>
                            <?php $count_sticky_area_2 = '0'; ?>
                            <?php while ( $sticky_list->have_posts() ) : $sticky_list->the_post(); ?>
                                <?php $count_sticky_area_2++;?>
                                <?php if(($count_sticky_area_2 > '1') && ($count_sticky_area_2 <= '5')): ?>
                                    <?php 
                                        $post_id            = get_the_id();
                                        $post_info          = get_post($post_id);
                                        $post_created       = $post_info->post_date;
