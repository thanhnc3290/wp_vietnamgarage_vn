...
$(document).ready(function() {
    // click show bo loc  
    $('.item-filter .title-filter').click(function() {

        if ($(this).parent().find(".content-filter").is(":visible"))
            $(this).parent().find(".content-filter").hide();
        else {
            $(".item-filter .content-filter").not(this).parent().find(".content-filter").hide();
            $(this).next().slideToggle(300);
            $(this).parent().find(".content-filter").show();
