...
<!DOCTYPE html>
<html lang="vi-vn">
<?php get_template_part('layout_mobile/product/header-single'); ?>
...
<body class="">
    <div class="container-mb">
        ...
        <div class="product-detail">
            ...
            <div class="main-product-detail">
                ...
                <div class="content-review">
                    ...
                    <div class="d-flex align-items" style="margin : 10px; 0">
                ...
                <div class="content-main-detail">
                    <div class="product-detail-image">
                        <div class="product-detail-gallery text-center">
                            <a data-fancybox="gallery" href="<?php echo $product_image_link ?>"></a>
                            <?php foreach($product_image_list as $img_id): ?>
                                <?php
                                    $image_link = wp_get_attachment_url($img_id);
                                ?>
                            <a data-fancybox="gallery" href="<?php echo $image_link ?>"></a>
                            <?php endforeach; ?>
                            <div id="sync1">
                                <a data-fancybox="gallery" href="<?php echo $product_image_link ?>">
                                    <img src="<?php echo $product_image_link ?>" alt="<?php echo $product_name ?>">
                                </a>
                            </div>

                            <div class="product-detail-thumbnail owl-carousel owl-theme custom-nav owl-loaded owl-drag"
                                id="sync2">
                                <div class="owl-stage-outer owl-height" style="height: 87.0781px;">
                                    <div class="owl-stage"
                                        style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 228px;">

                                        <div class="owl-item active" style="width: 66px; margin-right: 10px;">
                                            <div class="item-thumbnail active">
                                                <a href="<?php echo $product_image_link ?>" class="border-img">
                                        ...
                                        <div class="owl-item active" style="width: 66px; margin-right: 10px;">
                                            <div class="item-thumbnail active">
                                                <a href="<?php echo $image_link ?>" class="border-img">
                        ...
                        <div class="product-summary">
                            <div class="content" id="content-summary" style="height: 98px;">
                                <div class="d-flex flex-wrap">
                                    <?php echo $product_desc; ?>
                                    <p></p>
                                </div>
                            </div>
                            <a href="javascript:void()" class="item-btn more-all js-viewmore-content"
                                data-content="#content-summary" style="display: flex;">Đọc thêm</a>
                        </div>
                    </div>
                    <div class="product-detail-mid">
                        ...
                        <div class="product-btn-cart d-flex align-items">
                            ...
                            <div class="unit-detail-amount-control">
                                <a onclick="create_cart_minus()" href="javascript:;" data-value="-1"><i
                                        class="fa fa-minus"></i></a>

                                <input disabled type="text" size="3" data-total="1" value="1" id="js-buy-quantity">

                                <a onclick="create_cart_plus()" href="javascript:;" data-value="1"><i
                                        class="fa fa-plus"></i></a>
                            </div>

                            <div class="btn-buy">
                                <a id="button_add_to_cart"
                                    href="<?php echo site_url().'/gio-hang/?add-to-cart='.$product_id.'&quantity=1' ?>"
                                    class="" data-id="<?php echo $product_id ?>"
                                    data-name="">Mua ngay</a>
                            </div>
                            <script>
                            function create_cart_plus() {
                                ...
                                var url_add_to_cart = '<?php echo site_url()?>/gio-hang/?add-to-cart=' +
                                    '<?php echo $product_id ?>' + '&quantity=' + new_qty;
                            ...
                            <div class="btn-buy" style="width:100%;">
                                <a href="tel:<?php echo get_theme_hotline_number() ?>'.$product_id.'&quantity=1' ?>"
                                    class="buy-go-cart btn-buyNow js-buyNow" data-id="<?php echo $product_id ?>"
                                    data-name="">Gọi ngay: <?php echo get_theme_hotline_number(); ?></a>
                            </div>
                            <?php endif; ?>
                        </div>
                        <div class="note-phone-cart">
                            <p>Vui lòng gọi: <a href="tel:<?php echo get_theme_hotline_number(); ?>"
                                    class=""><?php echo get_theme_hotline_number(); ?></a> để được hỗ trợ lắp đặt tại
                                nhà.</p>
                        </div>
                    </div>
                    ...
                    <div class="product-detail-right">
                        ...
                        <div class="box-chinhsach">
                            ...
                            <div class="content">
                                <p><a href="<?php echo site_url().'/huong-dan-mua-hang'.'/'; ?>">Hướng dẫn mua hàng.</a>
                                </p>
                                <p><a href="<?php echo site_url().'/chinh-sach-bao-hanh-san-pham'.'/'; ?>'">Chính sách
                                        bảo hành sản phẩm.</a></p>
                                <p><a href="<?php echo site_url().'/chinh-sach-doi-tra-va-hoan-tien'.'/'; ?>">Chính sách
                                        đổi trả và hoàn tiền.</a></p>
                            </div>
                        </div>
                        <div class="box-chinhsach">
                        ...
                        <div class="box-chinhsach">
                            ...
                            <div class="content">
                                <p data-show-hover="#map1" data-view=".map">
                                    <?php echo get_theme_address_from_function(); ?></p>

                                <iframe id="map1" class="map"
                                    src="<?php echo get_theme_google_map_embed_from_function(); ?>" width="100%"
            ...
            <div class="tab-pro-detail" id="js-tab-pro-detail">
                <ul class="title-tab-ct">
                    <li class="<?php if(count($product_upsell_list) >= '1'){ echo 'active';} ?>">
                        <a data-toggle="tab" href="javascript:;" data-id="#related1" data-tab=".tab-rl"
                            data-holder="#product-related"
                            class="item <?php if(count($product_upsell_list) >= '1'){ echo 'active';} ?>">Sản phẩm tương
                            tự</a>
                    </li>
                    <li class="<?php if(count($product_upsell_list) < '1'){ echo 'active';} ?>">
                        <a data-toggle="tab" href="javascript:;" data-id="#related2" data-tab=".tab-rl"
                            data-holder="#product-related"
                            class="item <?php if(count($product_upsell_list) < '1'){ echo 'active';} ?>">Sản phẩm cùng
                            hãng</a>
                    </li>
                </ul>
                <div class="clearfix"></div>
                <div class="content-product-list-related">
                    <div class="product-list-related owl-carousel owl-theme custom-nav js-pro-carousel owl-loaded owl-drag <?php if(count($product_upsell_list) >= '1'){ echo 'active';} ?>"
                        id="related1">
                        <div class="owl-stage-outer">
                            <div class="owl-stage"
                                style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 952px;">
                                    ...
                                    <div class="product-item">
                                        ...
                                        <div class="product-info">
                                            <h2 class="product-title">
                                                <a
                                                    href="<?php the_permalink($row_product_id); ?>"><?php echo $row_product_info->name ?></a>
                                            </h2>

                                            <div class="product-price">
                                                <?php if($row_product_price_regular_price !== no_price()): ?>
                                                <del
                                                    class="old-price"><?php echo $row_product_price_regular_price ?></del>
                                                <span
                                                    class="item-price"><?php echo $row_product_price_sale_price ?></span>
                                                <?php else: ?>
                                                <del class="old-price"></del>
                                                <span
                                                    class="item-price"><?php echo $row_product_price_regular_price ?></span>
                                                <?php endif; ?>
                                            </div>
            ...
            <div class="detail-content-read">
                <div class="detail-description">
                    <h3 class="title"><span>Mô Tả Sản Phẩm</span></h3>
                    <div class="content" id="content-desc">
                        <p><?php echo $product_content; ?></p>
                    </div>
                    <a href="javascript:void(0)" class="more-all js-viewmore-content" data-content="#content-desc">
                        Xem thêm
                    </a>
                </div>
                <div class="detail-spec">
                    <h3 class="title"><span>Thông số kỹ thuật</span></h3>
        ...
        <?php get_template_part('layout_mobile/product/footer-single'); ?>
